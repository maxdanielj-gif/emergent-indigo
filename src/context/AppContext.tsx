...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  }, [aiProfile, savedPersonas, userProfile, gallery, journal, knowledgeBase, memories, apiKey, anthropicApiKey, asyncApiKey, elevenLabsApiKey, geminiApiKey, huggingFaceApiKey, fcmToken, autoSaveChat, autoJsonBackup, autoDriveBackup, isLoaded, isGoogleDriveConnected, lastInteractionTime, userId]);
  ...
  }, [aiProfile, savedPersonas, userProfile, gallery, journal, knowledgeBase, memories, apiKey, anthropicApiKey, asyncApiKey, elevenLabsApiKey, geminiApiKey, huggingFaceApiKey, fcmToken, autoSaveChat, autoJsonBackup, autoDriveBackup, isLoaded, isGoogleDriveConnected, lastInteractionTime, userId, saveData]);
  ...
  return (
    <AppContext.Provider value={{
      ...
      huggingFaceApiKey, setHuggingFaceApiKey: setHuggingFaceApiKeyState,
