        ...
        <header className="sticky top-0 z-30 px-4 py-3 border-b border-indigo-200 dark:border-indigo-800 flex justify-between items-center bg-indigo-50/80 dark:bg-indigo-950/80 backdrop-blur-md">
            ...
            <div className="flex items-center space-x-1">
                ...
                <div className="relative">
                    ...
                    {isMenuOpen && (
                        <div className="absolute right-0 mt-2 w-52 bg-indigo-100 dark:bg-indigo-900 rounded-2xl shadow-2xl border border-indigo-200 dark:border-indigo-800 py-2 z-50">
                            <button onClick={() => { setIsMenuOpen(false); handleClear(); }} className="w-full px-5 py-3 text-left text-sm text-indigo-900 dark:text-indigo-100 hover:bg-indigo-200 dark:hover:bg-indigo-800 flex items-center gap-3">
                                <RotateCcw className="w-4 h-4 flex-shrink-0" /> Clear Chat
                            </button>
                            <button 
                                onClick={() => {
                                    setIsMenuOpen(false);
                                ...
                                className="w-full px-5 py-3 text-left text-sm text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900 flex items-center gap-3"
                            >
                                <Trash2 className="w-4 h-4 flex-shrink-0" /> Delete Session
                            </button>
                        </div>
                    )}
                </div>
